...
public final class EppProtocolModule {
  ...
  @Singleton
  @EppProtocol
  static QuotaManager provideConnectionQuotaManager(
      @Config("eppServerQuota") RegistryConfigSettings.Quota quota, Optional<UnifiedJedis> jedis) {
    return new QuotaManager(quota, jedis.orElse(null), "connection");
  }
  ...
  @Singleton
  @IpQuota
  static QuotaManager provideIpQuotaManager(
      @Config("eppServerQuota") RegistryConfigSettings.Quota quota, Optional<UnifiedJedis> jedis) {
    return new QuotaManager(quota, jedis.orElse(null), "ip");
  }
}
